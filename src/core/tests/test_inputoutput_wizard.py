...
from rkd.core.exception import InterruptExecution
...
class TestWizard(BasicTestingCase):
    ...
    def test_finish_is_writing_values(self):
        ...
        with patch('rkd.core.api.inputoutput.open', tmp_wizard_file, create=True):
            task = TaskForTesting()
    ...
    def test_getpass_is_used_when_secret_switch_is_used(self):
        ...
        with patch('rkd.core.api.inputoutput.getpass') as getpass:
