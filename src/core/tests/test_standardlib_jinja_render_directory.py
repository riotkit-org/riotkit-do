...
class TestRenderDirectoryTask(BasicTestingCase):
    ...
    def test_iterates_over_subdirectories_including_depth_and_pattern(self):
        ...
        self.assertIn('"./tests/test_standardlib_jinja_render_directory.py" ' +
                      '-> "/tmp/tests/test_standardlib_jinja_render_directory.py"', renderings)
        self.assertIn('"./rkd/core/__init__.py" -> "/tmp/rkd/core/__init__.py"', renderings)
    ...
    def test_files_are_copied_when_not_matching_pattern_but_switch_was_used(self):
        ...
        with self.subTest('Check --copy-not-matching-files - the non (.*).j2 files should be just copied ' +
            ...
            self.assertIn('sh(cp -p "tests/test_standardlib_jinja_render_directory.py" ' +
    ...
    def test_files_are_called_to_be_deleted(self):
        ...
        self.assertEqual(['./tests/test_standardlib_jinja_render_directory.py'], deletions)
