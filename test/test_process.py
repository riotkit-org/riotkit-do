...
from rkd.process import carefully_decode, check_call
...
class TestProcess(BasicTestingCase):
    ...
    def test_streaming_callback_exception_does_not_hang_application_but_actually_raise_exception(self):
    ...
    def test_environment_is_passed_and_system_environment_still_available(self):
